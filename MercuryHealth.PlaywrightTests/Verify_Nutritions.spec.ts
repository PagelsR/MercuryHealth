...
test('Navigate to nutritions page and update value', async ({ page }) => {
  ...
  // Take screenshot
  await page.screenshot({ path: 'screenshot_nutrition_details_25-3.png', fullPage: true, timeout: 60000 });
  ...
  // Take screenshot
  await page.screenshot({ path: 'screenshot_nutrition_details_25-4.png', fullPage: true, timeout: 60000 });
